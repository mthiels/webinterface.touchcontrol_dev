...
Ext.Loader.addClassPathMappings({
  ...
  "Ext.ux.menu.Menu": "app/controller/musicPlaylist.js",
  "touchcontrol": "app"
});
...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "touchcontrol.controller.controlList": [],
  "touchcontrol.controller.fileShares": [],
  "touchcontrol.controller.musicAlbumList": [],
  "touchcontrol.controller.musicArtistList": [],
  "touchcontrol.controller.musicGenreList": [],
  "touchcontrol.controller.musicPlaylist": [],
  "touchcontrol.controller.musicSearchList": [],
  "touchcontrol.controller.musicSongList": [],
  "touchcontrol.controller.settings": [],
  "touchcontrol.controller.tvTitleList": [],
  "touchcontrol.controller.videoGenreList": [],
  "touchcontrol.controller.videoMovieList": [],
  "touchcontrol.controller.videoMovieView": [],
  "touchcontrol.controller.videoPlaylist": [],
  "touchcontrol.controller.videoSearchList": [],
  "touchcontrol.model.castMember": [],
  "touchcontrol.model.fileShare": [],
  "touchcontrol.model.musicAlbum": [],
  "touchcontrol.model.musicArtist": [],
  "touchcontrol.model.musicGenre": [],
  "touchcontrol.model.musicSearch": [],
  "touchcontrol.model.musicSong": [],
  "touchcontrol.model.playlist": [],
  "touchcontrol.model.tvVideoEpisode": [],
  "touchcontrol.model.tvVideoSeason": [],
  "touchcontrol.model.tvVideoShow": [],
  "touchcontrol.model.videoGenre": [],
  "touchcontrol.model.videoMovie": [],
  "touchcontrol.store.localMusicPlaylists": [],
  "touchcontrol.store.localVideoPlaylists": [],
  "touchcontrol.store.musicAlbums": [],
  "touchcontrol.store.musicArtists": [],
  "touchcontrol.store.musicGenres": [],
  "touchcontrol.store.musicPlaylists": [],
  "touchcontrol.store.musicSearches": [],
  "touchcontrol.store.musicSongs": [],
  "touchcontrol.store.shareMusicFiles": [],
  "touchcontrol.store.shareVideoFiles": [],
  "touchcontrol.store.tvVideoEpisodes": [],
  "touchcontrol.store.tvVideoSeasons": [],
  "touchcontrol.store.tvVideoShows": [],
  "touchcontrol.store.videoGenres": [],
  "touchcontrol.store.videoMovies": [],
  "touchcontrol.store.videoPlaylists": [],
  "touchcontrol.store.videoSearches": [],
  "touchcontrol.view.Main": [],
  ...
  "touchcontrol.view.playing.card": [],
  "touchcontrol.view.playlists.card": [],
  "touchcontrol.view.playlists.localMusicPlaylistView": [],
  "touchcontrol.view.playlists.localVideoPlaylistView": [],
  "touchcontrol.view.playlists.musicPlaylistView": [],
  "touchcontrol.view.playlists.videoPlaylistView": [],
  "touchcontrol.view.settings.card": [],
  "touchcontrol.view.shares.card": [],
  "touchcontrol.view.shares.musicSharesView": [],
  "touchcontrol.view.shares.videoSharesView": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "touchcontrol.view.music.localMusicPlaylist": [
    "widget.localMusicPlaylist"
  ],
  "touchcontrol.view.music.musicSearchList": [
    "widget.musicSearchList"
  ],
  "touchcontrol.view.music.searchButton": [
    "widget.searchButton"
  ],
  ...
  "touchcontrol.view.playing.card": [
    "widget.playingContainer"
  ],
  "touchcontrol.view.playlists.card": [
    "widget.playlistsContainer"
  ],
  "touchcontrol.view.playlists.localMusicPlaylistView": [
    "widget.localMusicPlaylistView"
  ],
  "touchcontrol.view.playlists.localVideoPlaylistView": [
    "widget.localVideoPlaylistView"
  ],
  "touchcontrol.view.playlists.musicPlaylistView": [
    "widget.musicPlaylistView"
  ],
  "touchcontrol.view.playlists.videoPlaylistView": [
    "widget.videoPlaylistView"
  ],
  "touchcontrol.view.settings.card": [
    "widget.settingsContainer"
  ],
  "touchcontrol.view.shares.card": [
    "widget.sharesContainer"
  ],
  "touchcontrol.view.shares.musicSharesView": [
    "widget.musicSharesView"
  ],
  "touchcontrol.view.shares.videoSharesView": [
    "widget.videoSharesView"
  ],
  "touchcontrol.view.tvShow.card": [
    "widget.tvVideoContainer"
  ],
  "touchcontrol.view.tvShow.tvEpisodeInfo": [
    "widget.tvEpisodeInfo"
  ],
  "touchcontrol.view.tvShow.tvEpisodeList": [
    "widget.tvEpisodeList"
  ],
  "touchcontrol.view.tvShow.tvEpisodeSelected": [
    "widget.tvEpisodeSelected"
  ],
  "touchcontrol.view.tvShow.tvSeasonList": [
    "widget.tvSeasonList"
  ],
  ...
  "touchcontrol.view.video.movieSelected": [
    "widget.movieSelected"
  ],
  "touchcontrol.view.video.videoGenresList": [
    "widget.videoGenresList"
  ],
  "touchcontrol.view.video.videoMediaList": [
    "widget.videoMediaList"
  ],
  "touchcontrol.view.video.videoMediaView": [
    "widget.videoMediaView"
  ]
});
